...
const projects = () => {
    ...
    const [cardsToShow, setCardsToShow] = useState(1); // Number of cards to show at once

    useEffect(()=>{
      const updateCardsToShow = () => {
        if (window.innerWidth >= 1024) {
          setCardsToShow(projectsData.length); // Show 4 cards on large screens
        }  else {
...
const prevProject = () => {
  ...
  return (
    ...
    w-full overflow-hidden' id='Projects'>
